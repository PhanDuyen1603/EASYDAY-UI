<template>
  <div class="summary entry-summary">
    ...
    <p class="price">
      <ins
        ><span class="woocommerce-Price-amount amount"
          ><bdi class="real-prices"
            ><span class="woocommerce-Price-currencySymbol real-price">£</span
            >100.13</bdi
          ></span
        ></ins
      >
    ...
    <form class="cart" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="add-to-cart-detail-wrap">
        ...
        <a v-else @click="addToCart(product)" data-quantity="1" class="d-flex align-items-center text-white">
          <span
            >
             <svg 
                    version="1.1"
                    ...
                    style="enable-background: new 0 0 483.1 483.1; width: 22px; margin-right: 10px; fill: white"
                    xml:space="preserve" 
                  >
                    <g>
                      <path
    ...
    <div class="organey-social-share">
      <a class="social-facebook" target="_blank" title="Share on facebook">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
      ...
      <a class="social-twitter" target="_blank" title="Share on Twitter">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
      ...
      <a class="social-linkedin" target="_blank" title="Share on LinkedIn">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
      ...
      <a class="social-pinterest" target="_blank" title="Share on Pinterest">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
      ...
      <a class="social-envelope" title="Email to a Friend">
