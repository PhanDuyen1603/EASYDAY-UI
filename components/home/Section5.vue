      ...
      <div>
		...
		c5.7,0,10.4,4.7,10.4,10.4V240.3z"
            ...
            <b-tab class="tab-prod-item" title="Vegetables"
              ><p>Vegetables</p></b-tab
            >
            <b-tab class="tab-prod-item" title="Fruits"><p>Fruits</p></b-tab>
            <b-tab class="tab-prod-item" title="Bread"><p>Bread</p></b-tab>
            <b-tab class="tab-prod-item" title="Meat"><p>Meat</p></b-tab>
          </b-tabs>
        </div>
      </div>
    </div>
