<template>
  <div>
    <ThemeBreadcrumb>Shop</ThemeBreadcrumb>
    <b-container class="mt-5">
      <section class="row">
        ...
        <div class="col-9">
          <div class="organey-sorting fix-padding section-header justify-content-between">
...
export default {
  ...
  mounted() {
    this.$store.dispatch('modules/products/searchProduct', {
      keySearch: this.$route.params.slug,
    })
  },
  methods: {
    changePage(p) {
